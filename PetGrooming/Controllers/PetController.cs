...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        //URL: /Pet/Add
        //it will only trigger when post method is send
        [HttpPost]
        public ActionResult Add(string PetName, Double PetWeight, String PetColor, int SpeciesID, string PetNotes)
        {
            ...
            //it will execute query after substituting sqlparams
        ...
        //[HttpPost] Update
        [HttpPost]
        public ActionResult Update(int id, string PetName, string PetColor, string PetNotes, int SpeciesID, double PetWeight)
        {
